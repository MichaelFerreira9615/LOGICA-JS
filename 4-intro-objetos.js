...
// crie uma variavel chamado frase, e coloque uma string "Eu tenho um carro com cambio [cvt]" - use template string

const frase = `Eu tenho um ${pessoa.carro.modelo} com cambio ${pessoa.carro.itens[1]}`;
